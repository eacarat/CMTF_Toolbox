function [f,G] = scp_fg_lbfgsb(Z, A, Znormsqr, beta)
% SCP_FG_LBFGSB Computes function and gradient of the CP function. SCP_FG_LBFGSB also 
% has the option of imposing sparsity on the weights of rank-one components.
%
%   [f,G] = scp_fg_lbfgsb(Z, A, Znormsqr, beta) 
%           
...
%
% See also SCP_WFG_LBFGSB, ACMTF_FG_LBFGSB
%
