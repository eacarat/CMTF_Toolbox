function [f,G] = spca_wfg_lbfgsb(Z, W, A, Znormsqr, beta)
% SPCA_WFG_LBFGSB Computes function and gradient of matrix factorization of data 
% with missing entries. SPCA_WFG_LBFGSB also has the option of imposing sparsity 
% on the weights of rank-one matrices.
%
%   [f,G] = spca_wfg_lbfgsb(Z, W, A, Znormsqr, beta)
%
...
%                      + 0.5* beta * sum(A{3})
%            where entries of A{3} are constrained to be nonnegative.
...
%
% See also SPCA_FG_LBFGSB, ACMTF_FG_LBFGSB
%
