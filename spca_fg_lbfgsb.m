function [f,G] = spca_fg_lbfgsb(Z, A, Znormsqr, beta)
% SPCA_FG_LBFGSB Computes function and gradient of matrix factorization. 
% SPCA_FG_LBFGSB also has the option of imposing sparsity on the weights of 
% rank-one matrices.
%
%   [f,G] = spca_fg_lbfgsb(Z, A, Znormsqr, beta)
%
% Input: Z : a matrix 
...
%                      + 0.5* beta * sum(A{3})
%            where A{3} is constrained to be nonnegative.
...
%
% See also SPCA_WFG_LBFGSB, ACMTF_FG_LBFGSB
%
